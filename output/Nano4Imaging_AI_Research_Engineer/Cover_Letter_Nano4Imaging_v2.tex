...
This experience is a good match for Nano4Imaging's work on real-time MRI navigation. The modality is different from the imaging problems I have worked on so far, but the medical setting is exactly the kind of environment in which I want to continue developing: close to clinical specialists, technically demanding, and focused on making interventions safer and more precise. I would be excited to bring my experience in deep learning, image registration, segmentation, experimentation, and clinical collaboration to the development of TRACKR.
