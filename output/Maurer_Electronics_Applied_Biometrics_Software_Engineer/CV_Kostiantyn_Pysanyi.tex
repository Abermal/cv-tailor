...
% Source of truth: cv/master_cv.tex. Tailored copy for Maurer Electronics GmbH.

\section{Professional Summary}
Applied Machine Learning Engineer with a strong research foundation and hands-on experience developing, evaluating, and productionizing computer-vision systems. Focused on robust 2D and 3D image analysis, systematic experimentation, and translating prototypes into reliable software.

\section{Technical Skills}
\resumeSubHeadingList
  \resumeItem{\textbf{ML \& CV}: \textbf{PyTorch/Lightning}, TensorFlow, JAX, Detectron2, MMEngine/MMCV/MMDetection, Albumentations, \textbf{Scikit-learn}, XGBoost, \textbf{OpenCV}, ITK, pyclesperanto, \textbf{NumPy}, \textbf{Pandas}, CVAT, Transformers/TIMM/Huggingface}
  \resumeItem{\textbf{Experimentation \& Tracking}: Jupyter Notebook/JupyterLab, \textbf{MLflow}, Tensorboard, Optuna, \textbf{DVC}, Matplotlib/seaborn/Plotly}
...
\resumeSubHeadingList
  \resumeSubheading
      ...
      \resumeSubHeadingList
          \resumeItem{\textbullet\ Built and productionized an end-to-end \textbf{2D--3D image registration} pipeline with mesh processing and alignment for 3D implant pose estimation from X-rays; improved acceptance rate by 45\% and reduced error by 15\% using GPU-accelerated Docker and Prefect}
          ...
          \resumeItem{\textbullet\ Implemented a reproducible ML pipeline with \textbf{DVC data versioning}, \textbf{MLflow experiment tracking}, and automated evaluation}
  ...
  \resumeSubheading
      ...
      \resumeSubHeadingList
          \resumeItem{\textbullet\ Developed an ML model for bio-signal classification using a high-performance computing cluster for pain assessment in surgical scenarios with non-responsive patients}
